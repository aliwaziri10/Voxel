...
- Priya's brother Dev joined the investigation ch.24 onward; ch.36-38 show him and Priya's sibling relationship as steady and close, with a hint of something more between Dev and Priya left open but undeveloped by book's end (worth revisiting in Book 3 if wanted). **Ch.8 establishes Dev, serving community-service hours at the substation, drops the "old-timer folk story" seed line to Mara/Wren/Caleb/Priya on the way out — this is the first appearance of the "pie lady never aging" thread that later leads to Walt Pruitt. Ch.9 develops this directly: Priya follows up privately with Dev, learns the fuller Walt Pruitt warning ("never ask Denise for a favor you're not willing to pay back double"), and the two reach a real reconciliation beat about trust rebuilt since his sentence — Dev agrees to take her to Walt as "just family," not a formal interview.**
...
- Continue the sequential continuity/voice/canon review below starting at ch.19.
