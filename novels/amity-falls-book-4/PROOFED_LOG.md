...
1-12 are DONE. Do not redo them. Remove this claim when ch.13-16 are stamped.
...
- Josiah vs Ambrose Whitlock, RESOLVED. Josiah signed the 1847 marginal note
  ...
  ch.7 (`b98711c`), ch.9 (`0041d89`), ch.12 (`0553dba`). Check any later
  "Ambrose Whitlock tried/failed/hid the terms" mention.
- Drake countdown "closed" verdict is RE-OPENED: ch.9 already has the printer
  ...
  (eight weeks, council in three days for press funding), ch.37 repeats the
...
- Anachronism pattern (FIXED in ch.8 and ch.12): early chapters treated the
  ...
  was deliberate" as past. Those are ch.36-45 events. Watch ch.13-35.
...
7. CALENDAR. Ch.5 late summer; ch.8 reads a "year-old" notebook with Jan-Feb
   ...
   noticed three days ago"); ch.12 November, "recorded last spring." Ch.4's
   cold-case review "next month" also unresolved. One calendar needed.
...
9. HARRIET'S HOME: assisted living (ch.4), gardening (ch.5), roses at home
   (ch.8), nursing home (ch.9), care facility (ch.12). Ch.4 Doris says she
   still visits asking about the gap.
10. KISS AND RUPTURE ARE EARLY. Ch.5 and ch.9 refer to the kiss interrupted by
    ...
    Beat map: first kiss ch.21, rupture ch.30.
...
## Not done
- Sequential read of ch.13-45 (ch.13-16 claimed above).
- Season/month and countdown pass. Check against Books 1-3.
